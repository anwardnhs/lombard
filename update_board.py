...
with open("src/components/GovernanceSection.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
old_map = """        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-10 gap-y-16">
...
new_map = """        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-10 gap-y-16">
          {board.map((member, idx) => (
            <div key={idx} className="group">
              <div className="aspect-[3/4] overflow-hidden bg-black/5 mb-6">
                <img 
              ...
              <div className="border-t border-[#0F120F]/10 pt-4 mt-2">
                <button 
...
with open("src/components/GovernanceSection.tsx", "w", encoding="utf-8") as f:
    f.write(content)
